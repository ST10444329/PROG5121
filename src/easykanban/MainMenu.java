...
public class MainMenu extends JFrame {
    ...
    public MainMenu(EasyKanbanApp app) {
        this.app = app;
        initUI();
    }
    ...
    private void initUI() {
        ...
        JButton longestTaskButton = new JButton("Show Longest Task");
    ...
    private void handleCreateTask() {
        String input = JOptionPane.showInputDialog(this, "How many tasks would you like to add?");
        try {
            ...
            List<EasyKanbanApp.Task> tasks = app.getTasks();
            StringBuilder taskReport = new StringBuilder("Tasks Added:\n");
            for (EasyKanbanApp.Task task : tasks) {
    ...
    private void handleShowReport() {
        ...
        for (EasyKanbanApp.Task task : app.getTasks()) {
    ...
    private void handleLongestTask() {
        EasyKanbanApp.Task longestTask = app.getTaskWithLongestDuration();
        if (longestTask != null) {
